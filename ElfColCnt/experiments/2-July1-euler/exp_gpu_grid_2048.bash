...
nvcc -O3 -DMETHOD=10 collision.cu -o prog_nsteps_mr_2K;    # Grid NSteps
echo "Compiled."
nvcc -O3 -DMETHOD=11 collision.cu -o prog_halfsteps_sr_2K; # Grid HalfSteps SingleRow
echo "Compiled."
nvcc -O3 -DMETHOD=12 collision.cu -o prog_nsteps_sr_2K;    # Grid NSteps SingleRow
echo "Compiled."

time {
	for progName in prog_nsteps_sr_2K prog_halfsteps_sr_2K prog_nsteps_mr_2K; do
